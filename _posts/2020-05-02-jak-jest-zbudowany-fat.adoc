...
Pierwsze 512 bajtów, a więc do offsetu `000001f0` zajmuje tzw. _Boot sector_*_ naszego urządzenia. Znajdują się tam szczegółowe informacje o używanym systemie plików na urządzeniu. Boot sector w FAT zawsze kończy się sekwencją `55 aa`.
